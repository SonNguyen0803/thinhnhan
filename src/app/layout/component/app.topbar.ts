...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, TranslateModule, AppConfigurator],
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            <button class="layout-menu-button layout-topbar-action" (click)="layoutService.onMenuToggle()">
                <i class="pi pi-bars"></i>
            </button>
            <a class="layout-topbar-logo" routerLink="/" style="text-decoration: none;">
                ...
                <span>thinhnhan</span> -->
                <img src="../../../assets/images/logo-home.png" style="height: 40px;">
            </a>
        </div>
...
export class AppTopbar {
    ...
    constructor(public layoutService: LayoutService, private router: Router, private authen: AuthenticationService) { }
    ...
    login() {
        const curr = this.authen.currentUser();
        if (curr) {
            console.log(curr)
        }
        else {
